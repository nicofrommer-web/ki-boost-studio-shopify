// Accordion Custom Element — KI Boost Studio
// Eigenständiges Custom Element ohne externe Theme-Utility-Abhängigkeiten.

const mediaQueryLarge = window.matchMedia('(min-width: 990px)');
